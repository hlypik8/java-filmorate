...
CREATE TABLE IF NOT EXISTS events (
  timestamp      BIGINT    NOT NULL,       -- время в формате UNIX timestamp
  user_id        INTEGER   NOT NULL,       -- пользователь, у которого произошло событие
  event_type     VARCHAR   NOT NULL,       -- LIKE, REVIEW или FRIEND
  operation      VARCHAR   NOT NULL,       -- ADD, REMOVE или UPDATE
  event_id       INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  entity_id      INTEGER   NOT NULL,       -- идентификатор фильма, отзыва или друга
