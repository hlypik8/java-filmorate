...
CREATE TABLE IF NOT EXISTS genres ( -- Изменено на множественное число
  id integer GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  name varchar NOT NULL
);

CREATE TABLE IF NOT EXISTS mpa_ratings ( -- Изменено на множественное число
  id integer GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  name varchar NOT NULL,
  description varchar
);

-- Исправленные внешние ключи (согласованные имена)
